...
public struct DiagnosticsWriter: Sendable {
    ...
    /// Write ``task_graph.json`` from a ``TaskGraphStore``.
    public func writeTaskGraph(_ store: TaskGraphStore) {
    ...
    /// Build a ``PathSnapshot`` from a ``GraphNavigator.ScoredPath`` with score breakdowns.
    public static func pathSnapshot(
        from path: GraphNavigator.ScoredPath,
        scorer: GraphScorer,
