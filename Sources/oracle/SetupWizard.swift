...
struct SetupWizard {
    ...
    func run() {
        ...
        print("  This app needs Accessibility permission to use Oracle OS.")
        print("")
    ...
    private func checkAccessibility(hostApp: String) -> Bool {
        ...
        // Not granted
        print("  Oracle OS reads the accessibility tree to see and operate apps.")
        ...
        print("  Then run `oracle setup` again.")
        print("")
        return false
    }
    ...
    private func checkScreenRecording(hostApp: String) -> Bool {
        ...
        printFail("Not granted (you can run `oracle setup` again later)")
        return false
    }
    ...
    private func printSummary(
        ...
        if accessibility && verified {
            ...
            if !vision {
                print("  Optional: Run `oracle setup` again to set up vision")
            }
            print("  Then run `oracle setup` again.")
        }
        print("  ======================================")
    ...
    private func printBanner() {
        print("")
        print("  Oracle OS v\(OracleOS.version) Setup")
        print("  ======================================")
        print("")
    }
